	...
	<body>
		...
		<div id="show-vote" class="content scaffold-show" role="main">
			...
			<ol class="property-list vote">
				...
				<g:if test="${voteInstance?.votDate}">
				<li class="fieldcontain">
					<span id="votDate-label" class="property-label"><g:message code="vote.votDate.label" default="Vot Date" /></span>
					
						<span class="property-value" aria-labelledby="votDate-label"><g:formatDate date="${voteInstance?.votDate}" /></span>
