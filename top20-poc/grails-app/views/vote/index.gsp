		...
		<div id="list-vote" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="votDate" title="${message(code: 'vote.votDate.label', default: 'Vot Date')}" />
				...
				<g:each in="${voteInstanceList}" status="i" var="voteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${voteInstance.id}">${fieldValue(bean: voteInstance, field: "votDate")}</g:link></td>
